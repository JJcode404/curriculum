...
1. Read [How screen readers navigate data tables](https://tink.uk/how-screen-readers-navigate-data-tables/) to see a great example of just how much context a proper `<table>` element provides. There is also a link to a video at the end of the blog post if you want to *hear* how a table is announced.
